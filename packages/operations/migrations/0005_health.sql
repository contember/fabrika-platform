...
ALTER TABLE health_checks ADD COLUMN interval_ms INTEGER NOT NULL DEFAULT 60000;
ALTER TABLE health_checks ADD COLUMN timeout_ms INTEGER NOT NULL DEFAULT 5000;
...
ALTER TABLE health_checks ADD COLUMN stale_after_ms INTEGER NOT NULL DEFAULT 180000;
ALTER TABLE health_checks ADD COLUMN due_at INTEGER NOT NULL DEFAULT 0;
ALTER TABLE health_checks ADD COLUMN claimed_until INTEGER;
