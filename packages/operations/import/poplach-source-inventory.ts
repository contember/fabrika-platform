...
export const POPLACH_SOURCE_INVENTORY: readonly PoplachInventoryEntry[] = [
	...
	{ path: 'src/lib/activity.ts', classification: 'domain', disposition: 'replaced', target: 'operations-contract ActivityKind and operations issue decisions' },
	...
	{ path: 'src/lib/consume.ts', classification: 'cloudflare-adapter', disposition: 'replaced', target: 'operations issue transition kernel; persistence deferred to WU2' },
	{ path: 'src/lib/count-store.ts', classification: 'cloudflare-adapter', disposition: 'deferred', target: 'WU2 occurrence-store port and adapters' },
	...
	{ path: 'src/queue.ts', classification: 'cloudflare-adapter', disposition: 'deferred', target: 'WU2 queue consumer and DLQ adapters' },
	{ path: 'src/rpc/errors.ts', classification: 'browser-contract', disposition: 'deferred', target: 'WU3/WU7 operator REST errors' },
	{ path: 'src/rpc/gates.ts', classification: 'browser-contract', disposition: 'replaced', target: 'operations direct/operator package separation; policy projection in WU3' },
	...
	{ path: 'src/rpc/procedures/alerts.ts', classification: 'browser-contract', disposition: 'deferred', target: 'WU2 alert repositories and WU7 routes' },
	...
	{ path: 'src/rpc/procedures/issues.ts', classification: 'browser-contract', disposition: 'replaced', target: 'operations-contract DTOs plus event-detail and issue decision kernels' },
	...
	{ path: 'src/spa/index.html', classification: 'standalone-deployment', disposition: 'deferred', target: 'WU7 unified console; standalone shell retires in WU9' },
	...
	{ path: 'migrations/0001_init.sql', classification: 'cloudflare-adapter', disposition: 'deferred', target: 'WU2 D1 and Postgres operations schemas' },
	{ path: 'migrations/0002_sent_alerts.sql', classification: 'cloudflare-adapter', disposition: 'deferred', target: 'WU2 alert repositories' },
	{ path: 'migrations/0003_event_counts_eventid.sql', classification: 'cloudflare-adapter', disposition: 'deferred', target: 'WU2 idempotent occurrence stores' },
	{ path: 'migrations/0004_issue_activity.sql', classification: 'cloudflare-adapter', disposition: 'deferred', target: 'WU2 activity repositories' },
	{ path: 'migrations/0005_issue_regressed.sql', classification: 'cloudflare-adapter', disposition: 'deferred', target: 'WU2 issue repositories' },
	{ path: 'migrations/0006_issue_snooze.sql', classification: 'cloudflare-adapter', disposition: 'deferred', target: 'WU2 issue repositories' },
	{ path: 'migrations/0007_issue_merge.sql', classification: 'cloudflare-adapter', disposition: 'deferred', target: 'WU2 issue repositories' },
	{ path: 'migrations/0008_alert_rules.sql', classification: 'cloudflare-adapter', disposition: 'deferred', target: 'WU2 alert repositories' },
	{ path: 'migrations/0009_notification_channels.sql', classification: 'cloudflare-adapter', disposition: 'deferred', target: 'WU2 alert repositories' },
	{ path: 'migrations/0010_drop_member_password_hash.sql', classification: 'standalone-deployment', disposition: 'replaced', target: 'Access owns identities; no Operations migration' },
	{ path: 'migrations/0011_drop_members_directory.sql', classification: 'standalone-deployment', disposition: 'replaced', target: 'Access owns identities; no Operations migration' },
	{ path: 'seeds/_lib.ts', classification: 'fixture', disposition: 'deferred', target: 'WU2 runtime-neutral repository fixtures' },
	{ path: 'seeds/alert-config.sql', classification: 'fixture', disposition: 'replaced', target: 'operations alert decision tests; storage fixture deferred to WU2' },
	...
	{ path: 'tests/browser/_helpers.ts', classification: 'fixture', disposition: 'replaced', target: 'operations/src/testing.ts; runtime helpers deferred to WU9' },
	...
	{ path: 'tests/browser/alerts-disabled.test.ts', classification: 'browser-contract', disposition: 'deferred', target: 'WU7/WU9 alert settings witness' },
	{ path: 'tests/browser/dsn-roundtrip.test.ts', classification: 'browser-contract', disposition: 'deferred', target: 'WU4/WU9 managed ingest witness' },
	{ path: 'tests/browser/email-channel.test.ts', classification: 'browser-contract', disposition: 'deferred', target: 'WU2/WU9 portable notification witness' },
	{ path: 'tests/browser/ingest-and-group.test.ts', classification: 'browser-contract', disposition: 'replaced', target: 'operations ingest and issue lifecycle tests; end-to-end witness in WU9' },
	{ path: 'tests/browser/ingest-validation.test.ts', classification: 'browser-contract', disposition: 'replaced', target: 'operations ingest tests; HTTP limits and auth in WU4' },
	{ path: 'tests/browser/issue-ignore.test.ts', classification: 'browser-contract', disposition: 'replaced', target: 'operations issue lifecycle tests; UI witness in WU7' },
	{ path: 'tests/browser/issue-tracking-extras.test.ts', classification: 'browser-contract', disposition: 'replaced', target: 'operations fingerprint and mutation tests; UI witness in WU7' },
	{ path: 'tests/browser/member-access.test.ts', classification: 'browser-contract', disposition: 'deferred', target: 'WU3/WU9 Access policy witness' },
	...
	{ path: 'tests/browser/project-setup.test.ts', classification: 'browser-contract', disposition: 'deferred', target: 'WU3/WU4 source provisioning witness' },
	{ path: 'tests/browser/resource-routes.test.ts', classification: 'browser-contract', disposition: 'deferred', target: 'WU4/WU5 HTTP method and parameter witness' },
	...
	{ path: 'tests/browser/source-maps.test.ts', classification: 'browser-contract', disposition: 'replaced', target: 'operations source-map tests; upload witness in WU5' },
	{ path: 'tests/browser/spike-alert.test.ts', classification: 'browser-contract', disposition: 'replaced', target: 'operations alert decision tests; delivery witness in WU2' },
	{ path: 'tests/browser/triage-issues.test.ts', classification: 'browser-contract', disposition: 'replaced', target: 'operations event-detail and issue mutation tests; UI witness in WU7' },
]
