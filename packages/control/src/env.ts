...
export interface Env {
	 ...
	 * terminal status → D1. Split into its own worker so a deploy of fabrika never resets the container
	 ...
	 * the escape hatch for the FIRST operator before propustka knows about fabrika. Mirrors propustka's
