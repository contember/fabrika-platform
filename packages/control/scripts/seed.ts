#!/usr/bin/env bun
/**
 * Seed the control-plane REGISTRY: the `apps` (fabrika, propustka) rows that let a GitHub push
 ...
 *
 * fabrika is SINGLE-ACCOUNT: there is no account registry to seed. The CF account/token + propustka
