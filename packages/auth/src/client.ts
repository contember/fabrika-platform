import type { AccessTokenClaims, DomainEvent, IamRpc, PermissionEntry, Scope } from '@fabrika/auth-core'
 ...
 * `IamRpc` contract from `@fabrika/auth-core` — never on the Worker — which is what keeps the
