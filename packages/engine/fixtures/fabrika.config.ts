// A realistic sample app config — used by `fabrika deploy --env=stage --dry-run` to exercise the
...
import { D1Database, defineApp, KVNamespace, Worker } from '@fabrika/config'
