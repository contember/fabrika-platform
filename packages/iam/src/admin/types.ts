// @fabrika/iam/admin — admin REST request/response DTOs.
//
// Consumed type-only by @fabrika/iam-ui (the opice dashboard pattern: end-to-end
// typed, no codegen). Reuses @fabrika/auth-core types where they fit. Keep these clean
