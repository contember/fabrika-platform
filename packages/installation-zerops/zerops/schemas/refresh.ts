...
//
//   bun packages/installation-zerops/zerops/schemas/refresh.ts
//
...
// and re-run `bun run --filter @fabrika/installation-zerops gen` — the generated import documents are derived from
