...
The operator-facing bring-up CLI. `bunx @fabrika/cli init <account>` stands up a CF account's fabrika
control-plane base. Assumes the root CLAUDE.md. The deploy ENGINE is `@fabrika/engine`; this package is only
