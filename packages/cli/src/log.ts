/**
 * Console formatting for the fabrika CLI — a thin, consistent presentation layer over the orchestration
 * in the other modules. Every line the operator sees during `init` flows through here.
 *
...
/** A numbered, bold section heading — the spine of the CLI's progress. Resets nothing else. */
...
/** A non-fatal warning (yellow ⚠) — the CLI keeps going. */
 ...
 * "create", paste a value back). These are the hand-off points the whole bring-up is built around, so
