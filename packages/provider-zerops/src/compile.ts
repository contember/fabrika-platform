...
//
//   1. TYPE. `ZeropsServiceSpec` / `ZeropsProjectSpec` are the platform's contract MINUS
...
import type { ZeropsProjectSpec, ZeropsResourceContext, ZeropsServiceSpec, ZeropsSourceTarget } from './types'
