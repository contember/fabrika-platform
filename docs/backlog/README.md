...
- [76](76-an-app-variable-never-reaches-a-zerops-service.md) — `apps.variables.put` is accepted and then does nothing on Zerops; the example's one required variable is set by hand.
